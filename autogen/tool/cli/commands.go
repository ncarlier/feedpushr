...
func RegisterCommands(app *cobra.Command, c *client.Client) {
	...
	command = &cobra.Command{
		Use:   "list",
		Short: `Retrieve all feeds`,
	}
	tmp7 := new(ListFeedCommand)
	sub = &cobra.Command{
		Use:   `feed ["/v1/feeds"]`,
		Short: ``,
